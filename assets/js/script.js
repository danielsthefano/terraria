...
function setSlider() {
    ...
    let cor1 = '#ffffff'; // Verde
    let cor2 = '#cd97ff'; // Dourado
    ...
    if (active === 0) {
        container.style.backgroundImage = 'radial-gradient(circle, #00ff00, #000000)';
        ...
        container.style.backgroundImage = 'radial-gradient(circle, #414240, #134e08)';
